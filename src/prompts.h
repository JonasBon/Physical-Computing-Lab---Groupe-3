...
// --- Prompts for ChatGPT ---
const char* PROMPT_IMAGE_RECOGNITION = "Gebe in nur 1-2 Wörtern zurück, um was für ein Lebensmittel es sich auf dem Bild handelt. Wenn du dir nicht sicher bist, dann sage \"unbekannt\". Zusätzlich erhälst du nun die Datenbank von Lebensmitteln, die sich im Kühlschrank befinden. Schaue, ob das von dir erkannte Produkt bereits in der Datenbank vorhanden ist, wenn auch nicht mit exakt dem Namen. Wenn ja, nutze als Namen für das Produkt den Namen, der bereits in der Datenbank vorhanden ist: ";
